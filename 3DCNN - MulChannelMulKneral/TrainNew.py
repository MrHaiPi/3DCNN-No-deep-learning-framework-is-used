...
if __name__== '__main__':
    ...
    # 训练数据路径
    path_train_data = r"E:\资料\大学\Graduation project\数据集\已采用\SKIG\Sequence\dep\3_CV(5-6test)\train"

    # 测试数据路径
    path_test_data = r"E:\资料\大学\Graduation project\数据集\已采用\SKIG\Sequence\dep\3_CV(5-6test)\test"
    ...
    # 网络结构
    size_layer = ['conv1a','pool1','conv2a','pool2','conv3a','pool3','conv4a','pool4','conv5a','pool5','fc1a','fc1b','fc1c']
    ...
    # 开始训练网络
    net_work.train(train_data_path_list, train_target, test_data_path_list, test_target, batch_size = 20, epoch = 20, mu = 0.0002, path = path_par_net_work)
