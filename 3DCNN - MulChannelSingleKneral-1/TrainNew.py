...
if __name__== '__main__':
    ...
    # 训练数据路径
    path_train_data = r"D:\Graduation project\数据集\已采用\SKIG\Sequence\dep\2_CV(3-4test)\train"

    # 测试数据路径
    path_test_data = r"D:\Graduation project\数据集\已采用\SKIG\Sequence\dep\2_CV(3-4test)\test"
