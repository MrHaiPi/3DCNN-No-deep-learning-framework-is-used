...
if __name__== '__main__':
    ...
    # 加载数据
    train_data_path_list, train_target = DataIo.load_data_path('TrainData', train_data_shape)
    ...
    # 加载测试数据
    test_data_path_list, test_target = DataIo.load_data_path('TestData', test_data_shape)
    ...
    # 开始训练网络
    net_work.train(train_data_path_list, train_target, test_data_path_list, test_target, batch_size = 40, epoch = 20, mu = 0.001, path = path_par_net_work)
