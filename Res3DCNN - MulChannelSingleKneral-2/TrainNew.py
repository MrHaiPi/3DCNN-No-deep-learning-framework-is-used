...
if __name__== '__main__':
    ...
    # 神经网络参数保存目录（根）
    path_par_net_work = "un"

    # 训练数据路径
    path_train_data = r"E:\Graduation project\数据集\已采用\SKIG\Sequence\dep\3_CV(5-6test)\train"

    # 测试数据路径
    path_test_data = r"E:\Graduation project\数据集\已采用\SKIG\Sequence\dep\3_CV(5-6test)\test"
    ...
    # 网络结构
    size_layer = ['conv1a','pool1','conv2a','pool2','conv3a','pool3','conv4a','pool4','fc1a','fc1b','fc1c']
